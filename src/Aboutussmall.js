...
<h>We provide the wings your business needs.</h>
        ...
        <Grid item xs={6} sm={7} className="about_text" >
         ...
         <p className="smallpara">We are the destination for your online journey of ideas and innovations.</p>

         <p className="smallpara">The one stop solution for all your online buisness needs. Whether you are just an individual dreaming of starting an online website or an established business creating an identity in the global market, we got you covered from 
the initial phases of designing and developing to your branding.
 Alpharule works on the motive of ideas getting real.</p>
 
<p className="smallpara">Our goal is to stand as per the client’s expectations
