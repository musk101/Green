...
function LinkPage(props) {
    ...
    return (
      ...
      <Dreamtext text1link="/digital" text2link="/content" text6link="/consulting" text7link="/branding" tex1="DIGITAL MARKETING" text2="CONTENT WRITING" text6="CONSULTING" text7="BRANDING" />
        <Footer/>
        </>
        </div>
    )
